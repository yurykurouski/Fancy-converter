...
export const flags = {
  [AvailableFiatNames.BYN]: BYN,
  [AvailableFiatNames.CAD]: CAD,
  [AvailableFiatNames.CHF]: CHF,
  [AvailableFiatNames.CNY]: CNY,
  [AvailableFiatNames.CZK]: CZK,
  [AvailableFiatNames.EUR]: EUR,
  [AvailableFiatNames.GBP]: GBP,
  [AvailableFiatNames.JPY]: JPY,
  [AvailableFiatNames.NOK]: NOK,
  [AvailableFiatNames.PLN]: PLN,
  [AvailableFiatNames.RUB]: RUB,
  [AvailableFiatNames.SEK]: SEK,
  [AvailableFiatNames.UAH]: UAH,
  [AvailableFiatNames.USD]: USD,
  [AvailableFiatNames.GEL]: GEL,
  [AvailableFiatNames.TRY]: TRY,
  [AvailableFiatNames.KZT]: KZT,
  [AvailableFiatNames.AMD]: AMD,
  [AvailableFiatNames.AZN]: AZN,
  [AvailableFiatNames.ALL]: ALL,
  [AvailableFiatNames.BAM]: BAM,
  [AvailableFiatNames.BGN]: BGN,
  [AvailableFiatNames.DKK]: DKK,
  [AvailableFiatNames.HRK]: HRK,
  [AvailableFiatNames.MDL]: MDL,
